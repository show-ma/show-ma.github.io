...
在这次博客优化中，我尝试对评论系统的“空状态提示文案”做定制，让没有评论时的页面不再只是简单的“来发评论吧～”，而是被迪腌入味的文案。
...
#### 1. 使用 Hugo 的 `data/emptyMessages.toml` 存储文案池

```toml
[[messages]]
text = "<span class=\"disco-blue\">故弄玄虚</span> <span class=\"disco-grey\">[极难:失败]</span> - 您的成就当中似乎没什么值得一提的。"

[[messages]]
text = "<span class=\"disco-yellow\">五感发达</span> <span class=\"disco-grey\">[中等:成功]</span> - 海鸥被轰鸣的电台吓了一跳，惊慌飞起。"
```
